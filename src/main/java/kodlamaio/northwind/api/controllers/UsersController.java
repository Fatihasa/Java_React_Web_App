...
public class UsersController {
	...
	public ResponseEntity<?> add(@Valid @RequestBody User user) {
		...
		//ok islem basarili demek
		//? bu isaret sunucun basarili ya da basarisiz olucagini bilmedigimiz icin kullaniyoruz.
		//Method icerisinde biz ne dondurursek sonuc olarak onu verir.
