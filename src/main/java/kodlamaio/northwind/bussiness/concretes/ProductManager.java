...
public class ProductManager implements ProductService{
	...
	@Override
	public DataResult<Product> getMyProductNameAndCategoryId(String productName, int categoryId) {
	...
	@Override
	public DataResult<List<Product>> getMyProductNameOrCategoryId(String productName, int categoryId) {
